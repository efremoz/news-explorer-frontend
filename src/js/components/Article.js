...
export default class Article extends BaseComponent {
  constructor(element) {
    ...
    this._counterDOM = this._element.querySelector('.article__count');
    this._username = this._element.querySelector('.article__name');
    this._text = this._element.querySelector('.article__text');
    this._keywords = this._text.querySelector('.article__keywords');
    this._saved = this._element.querySelector('.article__saved');
  ...
  _render() {
    ...
    this._saved.textContent = Article._setCases(this.counter, [
      NOMINATIVE_CASE,
      GENITIVE_CASE,
      ACCUSATIVE_CASE,
    ]);
